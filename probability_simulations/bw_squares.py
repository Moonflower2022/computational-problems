...
if __name__ == "__main__":
    test_ns = list(range(10, 40, 10)) + list(range(1000, 3000, 1000))
    iterations = 1000
    ...
    for test_n in test_ns:
        ...
        print(
            f"n={test_n}, avg_whites={avg_num_whites_remaining:.2f}, ratio={avg_num_whites_remaining/test_n:.4f}, time={iter_end-iter_start:.2f}s"
        )
